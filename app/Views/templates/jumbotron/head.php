...
<html lang="en">
<head>
    <!-- bootstrap example template: jumbotron -->
    <!-- modified by Xcy7e -->
    ...
    <link rel="stylesheet" href="<?=base_url('assets/templates/jumbotron/css/style.jumbotron.css')?>" type="text/css">
    <!-- jumbotron template js -->
    <script type="text/javascript" src="<?=base_url('assets/templates/jumbotron/js/script.jumbotron.js')?>"></script>
