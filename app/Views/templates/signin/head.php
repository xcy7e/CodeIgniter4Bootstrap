...
<html lang="en">
<head>
    <!-- bootstrap example template: signin -->
    <!-- modified by Xcy7e -->
    ...
    <!-- signin template css -->
    <link rel="stylesheet" href="<?=base_url('assets/templates/signin/css/style.signin.css')?>" type="text/css">
    <!-- signin template js -->
    <script type="text/javascript" src="<?=base_url('assets/templates/signin/js/script.signin.js')?>"></script>
