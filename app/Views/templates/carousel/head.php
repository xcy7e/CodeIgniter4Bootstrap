...
<html lang="en">
<head>
    <!-- bootstrap example template: carousel -->
    <!-- modified by Xcy7e -->
    ...
    <link rel="stylesheet" href="<?=base_url('assets/templates/carousel/css/style.carousel.css')?>" type="text/css">
    <!-- carousel template js -->
    <script type="text/javascript" src="<?=base_url('assets/templates/carousel/js/script.carousel.js')?>"></script>
