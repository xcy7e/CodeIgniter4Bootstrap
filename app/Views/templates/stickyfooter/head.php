...
<head>
    <!-- bootstrap example template: stickyfooter -->
    <!-- modified by Xcy7e -->
    ...
    <!-- stickyfooter template css -->
    <link rel="stylesheet" href="<?=base_url('assets/templates/stickyfooter/css/style.stickyfooter.css')?>" type="text/css">
    <!-- stickyfooter template js -->
    <script type="text/javascript" src="<?=base_url('assets/templates/stickyfooter/js/script.stickyfooter.js')?>"></script>
