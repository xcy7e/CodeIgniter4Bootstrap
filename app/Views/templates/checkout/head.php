...
<html lang="en">
<head>
    <!-- bootstrap example template: checkout -->
    <!-- modified by Xcy7e -->
    ...
    <link rel="stylesheet" href="<?=base_url('assets/templates/checkout/css/style.checkout.css')?>" type="text/css">
    <link href="<?=base_url('assets/templates/checkout/css/form-validation.checkout.css')?>" rel="stylesheet">
    <!-- checkout template js -->
    <script type="text/javascript" src="<?=base_url('assets/templates/checkout/js/script.checkout.js')?>"></script>
